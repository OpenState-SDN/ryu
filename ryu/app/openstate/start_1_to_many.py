...
os.system("xterm -e 'ryu-manager forwarding_consistency_1_to_many.py'&")
...
time.sleep(1)
print("\n********************************** HELP *********************************************")
print("\nType \"python echo_server.py 200\" in h2's xterm")
print("Type \"python echo_server.py 300\" in h3's xterm")
print("Type \"python echo_server.py 400\" in h4's xterm")
