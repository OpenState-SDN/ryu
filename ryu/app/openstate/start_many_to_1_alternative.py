...
os.system("xterm -e 'ryu-manager ~/ryu_exp/ryu/app/openstate/forwarding_consistency_many_to_1_alternative.py'&")
...
time.sleep(1)
print("\n********************************** HELP *********************************************")
print("Type \"python ~/ryu_exp/ryu/app/openstate/echo_server.py 200\" in h2's xterm")
