...
os.system("xterm -e 'ryu-manager ~/ryu.b/ryu/app/openstate/forwarding_consistency_1_to_many_ctrl.py'&")
...
time.sleep(1)
print("\n********************************** HELP *********************************************")
print("\nType \"python ~/ryu.b/ryu/app/openstate/echo_server.py 200\" in h2's xterm")
print("Type \"python ~/ryu.b/ryu/app/openstate/echo_server.py 300\" in h3's xterm")
print("Type \"python ~/ryu.b/ryu/app/openstate/echo_server.py 400\" in h4's xterm")
