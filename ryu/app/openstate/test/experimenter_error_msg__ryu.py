...
class OpenStateErrorExperimenterMsg(app_manager.RyuApp):
    ...
    def test3(self,datapath):
        ...
        key_lookup_extractor = osparser.OFPExpMsgKeyExtract(datapath=datapath, command=osproto.OFPSC_EXP_SET_L_EXTRACTOR, fields=[], table_id=0)
        datapath.send_msg(key_lookup_extractor)
        # I provide more fields than allowed
        key_lookup_extractor = osparser.OFPExpMsgKeyExtract(datapath=datapath, command=osproto.OFPSC_EXP_SET_L_EXTRACTOR, fields=[ofproto.OXM_OF_ETH_SRC,ofproto.OXM_OF_ETH_DST,ofproto.OXM_OF_IPV4_DST,ofproto.OXM_OF_TCP_SRC,ofproto.OXM_OF_TCP_DST,ofproto.OXM_OF_UDP_SRC,ofproto.OXM_OF_UDP_DST], table_id=0)
        datapath.send_msg(key_lookup_extractor)
    ...
    def test5(self,datapath):
        self.send_table_mod(datapath)
        key_lookup_extractor = osparser.OFPExpMsgKeyExtract(datapath=datapath, command=osproto.OFPSC_EXP_SET_L_EXTRACTOR, fields=[ofproto.OXM_OF_ETH_SRC], table_id=0)
        datapath.send_msg(key_lookup_extractor)
        key_update_extractor = osparser.OFPExpMsgKeyExtract(datapath=datapath, command=osproto.OFPSC_EXP_SET_U_EXTRACTOR, fields=[ofproto.OXM_OF_ETH_SRC], table_id=0)
        datapath.send_msg(key_update_extractor)
    ...
    def test22(self,datapath):
        command=osproto.OFPSC_EXP_STATEFUL_TABLE_CONFIG
        data=struct.pack(osproto.OFP_EXP_STATE_MOD_PACK_STR, command)
        data+=struct.pack(osproto.OFP_EXP_STATE_MOD_STATEFUL_TABLE_CONFIG_PACK_STR,250,1)
    ...
    def test23(self,datapath):
        self.send_table_mod(datapath)
        key_lookup_extractor = osparser.OFPExpMsgKeyExtract(datapath=datapath, command=osproto.OFPSC_EXP_SET_L_EXTRACTOR, fields=[ofproto.OXM_OF_ETH_SRC], table_id=250)
        datapath.send_msg(key_lookup_extractor)
    ...
    def _monitor0(self,datapath):
        ...
        self.test0(datapath)
        self.wait_for_two_errors(0,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_EXP_SET_EXTRACTOR,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_EXP_SET_EXTRACTOR)
    ...
    def _monitor2(self,datapath):
        ...
        self.test2(datapath)
        self.wait_for_error(2,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_TABLE_ID)
        self.restart_mininet()
    ...
    def _monitor3(self,datapath):
        ...
        self.test3(datapath)
        self.wait_for_two_errors(3,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor4(self,datapath):
        ...
        self.test4(datapath)
        self.wait_for_two_errors(4,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor5(self,datapath):
        ...
        self.test5(datapath)
        self.wait_for_error(5,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor6(self,datapath):
        ...
        self.test6(datapath)
        self.wait_for_error(6,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor7(self,datapath):
        ...
        self.test7(datapath)
        self.wait_for_error(7,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor8(self,datapath):
        ...
        self.test8(datapath)
        self.wait_for_error(8,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor9(self,datapath):
        ...
        self.test9(datapath)
        self.wait_for_error(9,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_TABLE_ID)
        self.restart_mininet()
    ...
    def _monitor14(self,datapath):
        ...
        self.wait_for_error(14,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_EXP_STATE_MOD_BAD_COMMAND)
        self.restart_mininet()
    ...
    def _monitor15(self,datapath):
        ...
        self.wait_for_error(15,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_MESSAGE)
        self.restart_mininet()
    ...
    def _monitor16(self,datapath):
        ...
        self.wait_for_error(16,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor17(self,datapath):
        ...
        self.wait_for_error(17,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_EXP_SET_FLOW_STATE)
        self.restart_mininet()
    ...
    def _monitor18(self,datapath):
        ...
        self.wait_for_error(18,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_EXP_DEL_FLOW_STATE)
        self.restart_mininet()
    ...
    def _monitor19(self,datapath):
        ...
        self.wait_for_error(19,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor20(self,datapath):
        ...
        self.wait_for_error(20,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_ACTION)
        self.restart_mininet()
    ...
    def _monitor21(self,datapath):
        ...
        self.wait_for_error(21,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor22(self,datapath):
        ...
        self.wait_for_error(22,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_TABLE_ID)
        self.restart_mininet()
    ...
    def _monitor23(self,datapath):
        ...
        self.test22(datapath)
        self.wait_for_error(23,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_TABLE_ID)
        self.restart_mininet()
    ...
    def _monitor24(self,datapath):
        ...
        self.wait_for_error(24,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_EXP_DEL_FLOW_STATE)
        self.restart_mininet()
    ...
    def _monitor25(self,datapath):
        ...
        self.wait_for_error(25,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_TABLE_ID)
        self.restart_mininet()
    ...
    def _monitor26(self,datapath):
        ...
        self.wait_for_error(26,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor27(self,datapath):
        ...
        self.wait_for_error(27,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor28(self,datapath):
        ...
        self.wait_for_error(28,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        self.restart_mininet()
    ...
    def _monitor29(self,datapath):
        ...
        self.wait_for_error(29,ofproto.OFPET_EXPERIMENTER,osproto.OFPEC_BAD_EXP_LEN)
        #self.restart_mininet()
