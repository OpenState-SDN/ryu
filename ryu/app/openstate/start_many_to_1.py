...
os.system("xterm -e 'ryu-manager forwarding_consistency_many_to_1.py'&")
...
print("*************************************************************************************")
net = Mininet(topo=mytopo,switch=UserSwitch,controller=RemoteController,cleanup=True,autoSetMacs=True,autoStaticArp=True)
net.start()
