...
#state ofp_flag_mod
OFP_EXP_FLAG_MOD_PACK_STR='!IIB7x'
OFP_EXP_FLAG_MOD_SIZE =24
assert (calcsize(OFP_EXP_FLAG_MOD_PACK_STR)) + OFP_HEADER_SIZE ==OFP_EXP_FLAG_MOD_SIZE

#enum ofp_flag_mod_command 
OFPSC_EXP_MODIFY_FLAGS = 0
OFPSC_EXP_RESET_FLAGS = 1

#state ofp_state_mod
OFP_EXP_STATE_MOD_PACK_STR='!BB'
OFP_EXP_STATE_MOD_SIZE =10
assert (calcsize(OFP_EXP_STATE_MOD_PACK_STR)) + OFP_HEADER_SIZE ==OFP_EXP_STATE_MOD_SIZE

# struct ofp_state_mod_state_entry
MAX_KEY_LEN=48
OFP_EXP_STATE_MOD_ENTRY_PACK_STR='!III'
OFP_EXP_STATE_MOD_ENTRY_SIZE = 12
assert (calcsize(OFP_EXP_STATE_MOD_ENTRY_PACK_STR) ==
        OFP_EXP_STATE_MOD_ENTRY_SIZE)
 
#struct ofp_state_mod_extraction
MAX_FIELD_COUNT=6
OFP_EXP_STATE_MOD_EXTRACT_PACK_STR='!I'
OFP_EXP_STATE_MOD_EXTRACT_SIZE = 4
assert (calcsize(OFP_EXP_STATE_MOD_EXTRACT_PACK_STR)==
          OFP_EXP_STATE_MOD_EXTRACT_SIZE)

#struct ofp_state_mod_statefulness_config
OFP_EXP_STATE_MOD_STATEFULNESS_CONFIG_PACK_STR='!Bx'
OFP_EXP_STATE_MOD_STATEFULNESS_CONFIG_SIZE = 2
assert (calcsize(OFP_EXP_STATE_MOD_STATEFULNESS_CONFIG_PACK_STR)==
          OFP_EXP_STATE_MOD_STATEFULNESS_CONFIG_SIZE)

#enum ofp_state_mod_command 
OFPSC_EXP_SET_L_EXTRACTOR = 0
OFPSC_EXP_SET_U_EXTRACTOR=1
OFPSC_EXP_SET_FLOW_STATE=2
OFPSC_EXP_DEL_FLOW_STATE=3
OFPSC_STATEFULNESS_CONFIG=4
