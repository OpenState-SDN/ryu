...
OFP_STATE_STATS_REQUEST_PACK_STR = (OFP_STATE_STATS_REQUEST_0_PACK_STR +
                                   _OFP_MATCH_PACK_STR)
OFP_STATE_STATS_REQUEST_SIZE = 16
assert (calcsize(OFP_STATE_STATS_REQUEST_PACK_STR) ==
        OFP_STATE_STATS_REQUEST_SIZE)
